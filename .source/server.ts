...
export const docs = await create.docs(
  ...
  { "meta.json": __fd_glob_0 },
  {
    ...
    "circles.mdx": __fd_glob_2,
    "concepts.mdx": __fd_glob_3,
    "gate.mdx": __fd_glob_4,
    "getting-started.mdx": __fd_glob_5,
    "index.mdx": __fd_glob_6,
    "memory.mdx": __fd_glob_7,
    "plugins.mdx": __fd_glob_8,
    "production.mdx": __fd_glob_9,
    "providers.mdx": __fd_glob_10,
    "safety.mdx": __fd_glob_11,
    "templates.mdx": __fd_glob_12,
  },
);
