(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
      ...
      constructor(...e) {
        super(...e),
          (this.handlePotentialScroll = () => {
            ...
            if (
              (a &&
                (n = "top" === a ? document.body : (document.getElementById(a) ?? document.getElementsByName(a)[0])),
  ...
  (e, t, r) => {
    ...
    let n = e.r(37743).createRenderSearchParamsFromClient;
    ("function" == typeof r.default || ("object" == typeof r.default && null !== r.default)) &&
      void 0 === r.default.__esModule &&
      (Object.defineProperty(r.default, "__esModule", { value: !0 }),
      Object.assign(r.default, r),
  ...
  (e, t, r) => {
    ...
    let n = e.r(51299).createRenderParamsFromClient;
    ("function" == typeof r.default || ("object" == typeof r.default && null !== r.default)) &&
      void 0 === r.default.__esModule &&
      (Object.defineProperty(r.default, "__esModule", { value: !0 }),
      Object.assign(r.default, r),
  ...
  (e, t, r) => {
    ...
    function E(e, t, r) {
      return new Proxy(e, {
        get: (e, n, a) => (
          "string" != typeof n || p.wellKnownProperties.has(n) || t.has(n) || g(R(r, n)), Reflect.get(e, n, a)
        ),
        has: (e, n) => (
          "string" != typeof n || p.wellKnownProperties.has(n) || t.has(n) || g(R(r, n)), Reflect.has(e, n)
        ),
      });
    }
    function O(e, t, r) {
  ...
  (e, t, r) => {
        ...
        switch (n.type) {
          ...
          case "validation-client":
            return (function (t, r, n) {
              var a;
              let { createExhaustiveSearchParamsProxy: o } = e.r(92336);
    ...
    function v(t, r, n, a) {
      ...
      if (n.validationSamples) {
        let { createExhaustiveSearchParamsProxy: a } = e.r(92336),
          o = new Set(Object.keys(n.validationSamples.searchParams ?? {}));
        t = a(t, o, r.route);
      }
      return (a ? n.asyncApiPromises.earlySharedSearchParamsParent : n.asyncApiPromises.sharedSearchParamsParent).then(
        () => t,
      );
    }
    let E = new WeakMap(),
  ...
  (e, t, r) => {
          ...
          case "request":
            if (s.asyncApiPromises && s.validationSamples)
              return (function (t, r, n, a, o) {
                let { createExhaustiveParamsProxy: i } = e.r(92336),
            ...
            if (
              ...
              return (a ? s.asyncApiPromises.earlySharedParamsParent : s.asyncApiPromises.sharedParamsParent).then(
                () => t,
              );
            return S(t);
        }
    ...
    function O(t, r, n) {
      let { createExhaustiveParamsProxy: a } = e.r(92336);
  ...
  (e, t, r) => {
    ...
    function l({ Component: t, serverProvidedParams: r }) {
      ...
      if ("u" < typeof window) {
        let r,
          a,
          { createSearchParamsFromClient: o } = e.r(62995);
        r = o(c);
        let { createParamsFromClient: i } = e.r(78875);
        return (a = i(u)), (0, n.jsx)(t, { params: a, searchParams: r });
      }
      {
        let { createRenderSearchParamsFromClient: r } = e.r(69328),
          a = r(c),
          { createRenderParamsFromClient: o } = e.r(91385),
          i = o(u);
  ...
  (e, t, r) => {
    ...
    function i({ Component: t, slots: r, serverProvidedParams: s }) {
      ...
      if ("u" < typeof window) {
        let { createParamsFromClient: a } = e.r(78875),
          o = a(l);
        return (0, n.jsx)(t, { ...r, params: o });
      }
      {
        let { createRenderParamsFromClient: a } = e.r(91385),
          o = a(l);
        return (0, n.jsx)(t, { ...r, params: o });
      }
    }
