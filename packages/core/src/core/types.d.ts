...
export type Flow = {
    ...
    readonly type: "provider.requested";
    readonly provider: string;
    readonly messages: number;
    readonly at: Date;
} | {
    readonly type: "provider.streamed";
    readonly provider: string;
    ...
    readonly type: "rune.requested";
    readonly rune: string;
    readonly at: Date;
} | {
    readonly type: "rune.completed";
    readonly rune: string;
    readonly at: Date;
} | {
    readonly type: "rune.failed";
    readonly rune: string;
    readonly error: string;
    readonly at: Date;
} | {
    readonly type: "rune.denied";
    readonly rune: string;
    ...
    readonly type: "circle.connected";
    readonly circle: string;
    readonly kind: string;
    readonly at: Date;
} | {
